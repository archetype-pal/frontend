...
export const backofficeKeys = {
  ...
  characters: {
    ...
    detail: (id: number) =>
      [...backofficeKeys.characters.all(), 'detail', id] as const,
  },
  components: {
  ...
  publications: {
    ...
    detail: (slug: string) =>
      [...backofficeKeys.publications.all(), 'detail', slug] as const,
  },
  events: {
    all: () => [...backofficeKeys.all, 'events'] as const,
    detail: (slug: string) =>
      [...backofficeKeys.events.all(), 'detail', slug] as const,
  },
  comments: {
    all: () => [...backofficeKeys.all, 'comments'] as const,
    list: (filter?: string) =>
      [...backofficeKeys.comments.all(), 'list', filter] as const,
  },
  carousel: {
  ...
  scribes: {
    ...
    detail: (id: number) =>
      [...backofficeKeys.scribes.all(), 'detail', id] as const,
  },
  hands: {
    ...
    detail: (id: number) =>
      [...backofficeKeys.hands.all(), 'detail', id] as const,
  },
  scripts: {
  ...
  searchEngine: {
    ...
    task: (taskId: string) =>
      [...backofficeKeys.all, 'searchEngine', 'task', taskId] as const,
  },
} as const
