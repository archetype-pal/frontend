    ...
    <footer className="bg-gray-100 mt-8 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-center items-center mb-8">
          {partners.map((partner) => (
            <div key={partner.name} className="m-4">
              ...
              <img src={partner.logo} alt={partner.name} width={100} height={50} loading="lazy" />
            </div>
          ))}
        </div>
        ...
        <p className="text-sm text-gray-600 text-center mb-4">
          ©2015-17 Models of Authority: Scottish Charters and the Emergence of Government,
          1100–1250. Some parts of this site are available under a CC-BY or other licence. All
          images of manuscripts and charters on this website are copyright of the respective
          repositories and are reproduced with permission. See further Acknowledgements and Image
          Rights.
        </p>
        <p className="text-sm text-gray-600 text-center mb-4">
          The Models of Authority project is funded by the Arts and Humanities Research Council
          (AHRC) under Grant Reference n° AH/L008041/1.
        </p>
        <p className="text-sm text-gray-600 text-center mb-4">
          This site uses Cookies. For further details see our Privacy and Cookie Policy.
        </p>
