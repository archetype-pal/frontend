...
export const COLUMNS: { [K in ResultType]: Column<ResultMap[K]>[] } = {
  manuscripts: [
    {
      header: 'Repository City',
      accessor: (m) => m.repository_city,
      sortKey: 'repository_city_exact',
    },
    ...
    { header: 'Shelfmark', accessor: (m) => m.shelfmark, sortKey: 'shelfmark_exact' },
    {
      ...
      accessor: (m) => m.catalogue_numbers,
