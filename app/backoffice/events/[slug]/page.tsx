...
import { getEvent, updateEvent, deleteEvent } from '@/services/backoffice/publications';
...
export default function EventEditorPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    <div className="max-w-4xl space-y-6">
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-2">
          <Link href="/backoffice/events" className="text-muted-foreground hover:text-foreground">
