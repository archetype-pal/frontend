  ...
  const bulkActions: BulkAction[] = [
    {
      ...
      action: async (ids) => {
        try {
          await Promise.all(
            ids.map((id) => deleteGraph(token!, Number(id)))
          )
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-3'>
          <div className='space-y-1'>
            ...
            <Select
              ...
              onValueChange={(val) => { setAnnotationType(val); setPage(0) }}
            >
          ...
          <div className='space-y-1'>
            ...
            <Input
              ...
              placeholder='e.g. 42'
              value={handFilter}
              onChange={(e) => { setHandFilter(e.target.value); setPage(0) }}
            />
          </div>
          <div className='space-y-1'>
            ...
            <Input
              ...
              onChange={(e) => { setAllographFilter(e.target.value); setPage(0) }}
            />
          </div>
        </div>
